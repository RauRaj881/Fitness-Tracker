...
const Sidebar = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-64 bg-slate-50 dark:bg-[#0B1221] text-slate-600 dark:text-gray-400 p-4 border-r border-slate-200 dark:border-gray-800 transition-colors">
      {/* Logo Section */}
          ...
          return (
            <Link
              ...
              className={`relative flex items-center gap-4 px-4 py-3 rounded-md transition-all group ${
                isActive
                  ? "text-[#10B981] bg-[#10B981]/10 dark:bg-[#10B981]/5"
                  : "hover:text-slate-900 dark:hover:text-white hover:bg-slate-200 dark:hover:bg-white/5"
              }`}
            >
      ...
      <div className="pt-4 border-t border-slate-200 dark:border-gray-800">
        <button
          onClick={toggleTheme}
          className="flex items-center gap-4 px-4 py-3 w-full hover:text-slate-900 dark:hover:text-white transition-colors"
        >
